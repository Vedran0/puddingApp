...
$(function() {
  $.confetti = new function() {
    ...
    function SetGlobals() {
        $('body').append('<canvas id="confettiCanvas" style="position:absolute;top:0;left:0;right:0; height: 100%;display:none; z-index: 0;"></canvas>');
...
self.addEventListener( 'fetch', function(event) {
    console.log('[PWA] The service worker is serving the page');
