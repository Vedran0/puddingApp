...
PatchNote.create(version: "Christmas 2017 edition",
                description: "<p>Ho ho hooo!</p>
                <p>As i promised here is the Christmas patch for your favorite app.</p>
                <p>★ In this patch i changed... well... <a class='in_text-link' target='_blank' href='https://en.wikipedia.org/wiki/Everything'>everything</a> xD</p>
                <p>Enjoy it while it lasts!</p>
                <p>P.S.: Don't tell anyone but: <a class='in_text-link' target='_blank' href='https://www.youtube.com/watch?v=yXQViqx6GMY'>All i want for Christmas is youuuuu!</a> :*</p>")

Setting.all.update(background: "christmas_two");